...
var card_type_resource = preload("res://Scripts/resources/card_type_res.gd")
var card_size = Vector2(39,55)
...
func create_deck(sprite_sheet: Texture2D):
	...
	for suit in range(4):
		for card in range(13):
			...
			new_card.card_suit = card_type.suit.values()[3-suit]
			...
			card_texture.region.position = Vector2(40*card, 56*suit)
